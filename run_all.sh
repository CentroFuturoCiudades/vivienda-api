...
# time poetry run python3 -m src.scripts.gather_buildings "$original_dir" "$tmp_dir" $CITY_NAME $VERBOSE_OPTION
...
# time python3 -m src.scripts.utilization "$original_dir" "$tmp_dir" $VERBOSE_OPTION
